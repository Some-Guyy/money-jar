                    ...
                    {this.state.view == 'jarlist'
                        ...
                        : (this.state.view == 'jarfocus'
                            ...
                            : (this.state.view == 'jarnew'
                                ...
                                : <View style={{ height: '90%' }}><Profile user={this.props.user} jars={this.state.jars} logout={this.props.logout} resetPwd={this.props.resetPwd} deleteAcc={this.props.deleteAcc} /></View>
                            )
                        )
                    }
