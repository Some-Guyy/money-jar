        ...
        return (
            <ViewFadeIn style={{ alignItems: 'center' }}>
                ...
                <View style={{ height: '7%', flexDirection: 'row' }}>
                    ...
                    <TextInput value={this.state.nameField} ref={'nameField'} onSubmitEditing={_ => this.refs.valueField.focus()} onChangeText={text => { this.setState({ nameField: text }) }} style={[styles.bodyText, { width: '50%', borderColor: dominantColor, borderWidth: 1 }]} />
                ...
                <View style={{ height: '7%', flexDirection: 'row' }}>
                    ...
                    <TextInput value={this.state.valueField} ref={'valueField'} onSubmitEditing={_ => this.refs.nameField.focus()} onChangeText={text => this.numbersOnlyValue(text)} style={[styles.bodyText, { width: '50%', borderColor: dominantColor, borderWidth: 1 }]} keyboardType='numeric' />
                    <View style={{ width: '20%' }}></View>
                </View>
                ...
                <TextInput value={this.state.addField} onSubmitEditing={this.props.addJarValue.bind(this, this.props.focusedJar.id, this.state.addField)} onChangeText={text => this.numbersOnlyAdd(text)} style={[styles.bodyText, { height: '7%', width: '30%', borderColor: dominantColor, borderWidth: 1 }]} keyboardType='numeric' />
                <View style={{ height: '2%' }}></View>
