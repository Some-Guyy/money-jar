        ...
        return (
            <ViewFadeIn style={{ alignItems: 'center' }}>
                ...
                <View style={{ height: '7%', flexDirection: 'row' }}>
                    ...
                    <TextInput value={this.state.nameField} onSubmitEditing={_ => this.refs.valueField.focus()} onChangeText={text => { this.setState({ nameField: text})}} style={[styles.bodyText, { width: '50%', borderColor: dominantColor, borderWidth: 1 }]} />
                ...
                <View style={{ height: '7%', flexDirection: 'row' }}>
                    ...
                    <TextInput value={this.state.valueField} ref={'valueField'} onSubmitEditing={this.props.addJar.bind(this, this.state.nameField, this.state.valueField)} onChangeText={text => this.numbersOnlyValue(text)} style={[styles.bodyText, { width: '50%', borderColor: dominantColor, borderWidth: 1 }]} keyboardType='numeric' />
                    <View style={{ width: '20%' }}></View>
                </View>
